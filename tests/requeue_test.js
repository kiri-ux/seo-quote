// A LOST CAPTURE TASK IS RE-QUEUED, ONCE. The "gone" reply carried an `error`
// key, and post() throws on any body with one -- so the poll never reached the
// branch built for exactly this case and the retry could not run.
